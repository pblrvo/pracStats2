...
simulate_game = function(r, n){
  trozos = floor(runif(n, 1, 999999999))
  m = max(trozos)
  antes_r_trozos = trozos[1:r]
  despues_r_trozos = tail(trozos, r)
  mejor_r = max(antes_r_trozos)
  acierto = 0
...
caja2 = c("P","P")
caja3 = c("O","P")
cajas = c(caja1,caja2,caja3)
resultado = 0
resultado2 = 0

pruebas_OroOro = replicate(10000,{
  caja_aleatoria = sample(cajas,2) #Me coge aleatoriamente una caja
  caja_aleatoria
  is_2gold = (caja_aleatoria == caja1)
  is_2gold
  sum(is_2gold)
  if(sum(is_2gold) == 2){
...
pruebas_2sivler = replicate(10000,{
  caja_aleatoria2 = sample(cajas,2)
  caja_aleatoria2
  is_2silver = (caja_aleatoria2 == caja2)
  is_2silver
  sum(is_2silver)
  if(sum(is_2silver) == 2){
